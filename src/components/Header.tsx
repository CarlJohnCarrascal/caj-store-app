          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-4">
                  ...
                  <SheetContent side="left" className="w-full max-w-xs sm:max-w-sm flex flex-col p-0">
                    <SheetHeader className="p-6 pb-2">
                      <SheetTitle className="text-left">
                          <Link href={isAdmin ? "/superadmin" : "/admin"} onClick={() => setIsMenuOpen(false)} className="flex items-center gap-2">
                              <LayoutDashboard />
                              CajStore
                          </Link>
                      </SheetTitle>
              ...
              <div className="hidden md:flex items-center gap-2">
                <Link href={isAdmin ? "/superadmin" : "/admin"} className="text-lg font-bold flex items-center gap-2">
