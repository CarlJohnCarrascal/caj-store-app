...
import PublicProductForm from '../../components/PublicProductForm';
...
export default function EditPublicProductPage() {
  ...
  return (
    <div>
      <h1 className="text-3xl font-bold mb-6">Edit Public Product</h1>
      <PublicProductForm product={product} />
    </div>
  );
}
